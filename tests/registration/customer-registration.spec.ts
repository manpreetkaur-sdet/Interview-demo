...
test.describe('Customer Registration', () => {
  ...
  test('Customer can successfully register', async ({
    loginPage,
  }) => {
    ...
    await registrationPage.enterCompanyAndLegalForm(
    ...
    await expect(
      registrationPage.confirmEmailMessage,
    ).toBeVisible();
  });
  ...
  test.describe('Required Field Validation', () => {
    ...
    test(
      'Create Account button should remain disabled when required fields are incomplete',
      async ({ loginPage }) => {
        const registrationPage =
          await loginPage.openCustomerRegistration();
        ...
        // Email
        await registrationPage.enterNewEmail(
          customer.email,
        );
    ...
    test(
      'Create Account button should be enabled when all required fields are valid',
      async ({ loginPage }) => {
        const registrationPage =
          await loginPage.openCustomerRegistration();
  ...
  test.describe('Email Validation', () => {
    ...
    for (const email of invalidEmails) {
      ...
      test(
        ...
        async ({ loginPage }) => {
          ...
          ).toHaveText(emailValidationError);
        },
      );
    }
    ...
    test(
      'Should allow registration after correcting invalid email',
      async ({ loginPage }) => {
  ...
  test.describe('Password Validation', () => {
    ...
    for (const password of invalidPasswords) {
      ...
      test(
        `Should show validation error for invalid password: ${password}`,
        async ({ loginPage }) => {
          ...
          ).toHaveText(passwordValidationError);
        },
      );
    }
  ...
  test.describe('Terms and Conditions', () => {
    ...
    test(
      'Create Account button should remain disabled when Terms and Conditions are not accepted',
      async ({ loginPage }) => {
    ...
    test(
      'Create Account button should become enabled after accepting Terms and Conditions',
      async ({ loginPage }) => {
